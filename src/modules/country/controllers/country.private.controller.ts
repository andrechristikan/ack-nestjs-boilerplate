...
import { CountryPrivateListDoc } from 'src/modules/country/docs/country.private.doc';
...
@ApiTags('modules.private.country')
@Controller({
    version: '1',
    path: '/country',
})
export class CountryPrivateController {
    constructor(
        private readonly countryService: CountryService,
        private readonly paginationService: PaginationService
    ) {}

    @CountryPrivateListDoc()
