 ...
 * @public
 */
export const ResponsePaginationMetadataSchema = ResponseMetadataSchema.extend({
 ...
 * @public
 */
export type ResponsePaginationMetadataDto = z.infer<
    typeof ResponsePaginationMetadataSchema
> &
    ResponseMetadataDto;
