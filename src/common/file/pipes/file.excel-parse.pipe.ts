...
export class FileExcelParsePipe<T> implements PipeTransform {
    /**
     * Set of supported MIME types for Excel and CSV files.
     * Using a Set for O(1) lookup performance when validating file types.
     */
     ...
     *
     * @param value - The uploaded file to process
     * @returns Promise resolving to an array of file sheets with parsed data, or undefined if no file provided
