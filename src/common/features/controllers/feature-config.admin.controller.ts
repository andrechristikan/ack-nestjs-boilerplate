...
import { ENUM_POLICY_ACTION, ENUM_POLICY_ROLE_TYPE, ENUM_POLICY_SUBJECT } from 'src/modules/policy/enums/policy.enum';
import { PolicyAbilityProtected, PolicyRoleProtected } from 'src/modules/policy/decorators/policy.decorator';
...
export class FeatureConfigAdminController {
  ...
  constructor(
    private readonly featureSettingService: FeatureConfigService,
  ) {
  }
