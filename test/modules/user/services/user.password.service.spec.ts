...
describe('UserPasswordService', () => {
    const userPasswordRepository = createMock<UserPasswordRepository>();
    const userRepository = createMock<UserRepository>();
    const userTwoFactorRepository = createMock<UserTwoFactorRepository>();
    const passwordHistoryService = createMock<PasswordHistoryService>();
    ...
    const authPasswordService = createMock<AuthPasswordService>();
    ...
    describe('changePassword', () => {
        ...
        it('validates 2FA, revokes sessions, updates the password, marks the factor used, and notifies the user', async () => {
