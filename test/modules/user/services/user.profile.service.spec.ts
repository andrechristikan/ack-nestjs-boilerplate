...
describe('UserProfileService', () => {
    const userRepository = {
        ...
        existByUsername: vi.fn<UserRepository['existByUsername']>(),
    ...
    const countryService = {
        existById: vi.fn<CountryService['existById']>(),
    } satisfies Pick<CountryService, 'existById'>;
    const userUtil = {
    ...
    beforeEach(async () => {
        ...
        countryService.existById.mockResolvedValue({ id: 'country-id' });
        userUtil.checkUsernamePattern.mockReturnValue(false);
        userUtil.checkBadWord.mockResolvedValue(false);
        userRepository.existByUsername.mockResolvedValue(null);
        ...
        service = moduleRef.get(UserProfileService);
    });
    ...
    describe('updateProfile', () => {
        it('updates profile data after validating the country', async () => {
            ...
            expect(countryService.existById).toHaveBeenCalledWith('country-id');
        ...
        it('throws CountryNotFoundException when the country id is unknown', async () => {
            countryService.existById.mockResolvedValue(null);
    ...
    describe('claimUsername', () => {
        ...
        it('throws UserUsernameNotAllowedException before checking other username failures', async () => {
            ...
            userRepository.existByUsername.mockResolvedValue({
                id: 'other-id',
            });
