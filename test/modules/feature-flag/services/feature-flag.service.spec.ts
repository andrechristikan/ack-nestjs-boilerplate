...
describe('FeatureFlagService', () => {
    ...
    const featureFlagCacheService = {
        getByKeyAndCache: vi.fn<FeatureFlagCacheService['getByKeyAndCache']>(),
        deleteCacheByKey: vi.fn<FeatureFlagCacheService['deleteCacheByKey']>(),
    } satisfies Pick<
        FeatureFlagCacheService,
        'getByKeyAndCache' | 'deleteCacheByKey'
    >;
