...
describe('ApiKeyService', () => {
    ...
    const apiKeyCredentialService = {
        createSecret: vi.fn<ApiKeyCredentialService['createSecret']>(),
        createHash: vi.fn<ApiKeyCredentialService['createHash']>(),
        validateCredential:
            vi.fn<ApiKeyCredentialService['validateCredential']>(),
    } satisfies Pick<
        ApiKeyCredentialService,
        'createSecret' | 'createHash' | 'validateCredential'
    >;
    const apiKeyCacheService = {
        getCacheByKey: vi.fn<ApiKeyCacheService['getCacheByKey']>(),
        setCacheByKey: vi.fn<ApiKeyCacheService['setCacheByKey']>(),
        deleteCacheByKey: vi.fn<ApiKeyCacheService['deleteCacheByKey']>(),
    } satisfies Pick<
        ApiKeyCacheService,
    ...
    beforeEach(async () => {
        ...
        const moduleRef: TestingModule = await Test.createTestingModule({
            providers: [
                ...
                {
                    provide: ApiKeyCredentialService,
                    useValue: apiKeyCredentialService,
                },
                { provide: ApiKeyCacheService, useValue: apiKeyCacheService },
